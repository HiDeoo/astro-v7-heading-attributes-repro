...
1. Visit [`http://localhost:4321/test/`](http://localhost:4321/test/) in your browser and notice the second heading ID is not `custom-id` but the default generated ID `heading-with-custom-id`
